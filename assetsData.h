...
static inline Sprite getSprite(SpriteID spriteID) {
    ...
    switch(spriteID) {
        ...
        case SPRITE_BULLET: { s.coords = (Rectangle){1102, 97, 192, 48}; s.pivotOffset = (Vector2){0, 0}; s.numFrames = 6; s.spriteID = SPRITE_BULLET; break; }
        ...
        case SPRITE_HEART: { s.coords = (Rectangle){981, 97, 17, 17}; s.pivotOffset = (Vector2){0, 0}; s.numFrames = 1; s.spriteID = SPRITE_HEART; break; }
        ...
        case SPRITE_UPGRADEDAMAGE: { s.coords = (Rectangle){1048, 97, 48, 67}; s.pivotOffset = (Vector2){0, 0}; s.numFrames = 1; s.spriteID = SPRITE_UPGRADEDAMAGE; break; }
        ...
        case SPRITE_UPGRADEMULTISHOT: { s.coords = (Rectangle){999, 97, 48, 67}; s.pivotOffset = (Vector2){0, 0}; s.numFrames = 1; s.spriteID = SPRITE_UPGRADEMULTISHOT; break; }
        default: break;
    }
    return s;
}
