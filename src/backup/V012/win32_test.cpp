        ...
        int       ShowCode)
{
	...
	if(Window)
	{
	    ...
	    int YOffset = 0;
            ...
            // win32_FillSoundBuffer(&SoundOutput, 0, SoundOutput.SecondaryBufferSize, SoundBuffer);
		...
		GameUpdateAndRender(&GameBuffer, &SoundBuffer, XOffset, YOffset, SoundOutput.ToneHz);
